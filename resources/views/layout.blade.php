...
<header class="p-3 text-bg-dark white">
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                ...
                <li><a href="/library" class="nav-link px-2 text-white">Your books</a></li>
            </ul>
            ...
            <div class="text-end">
                <a class="btn btn-outline-primary text-white" href="/login">Login</a>
